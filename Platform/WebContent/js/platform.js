...
var textureLoader;
var menu = false;
var level1StartPosition = new THREE.Vector3(UNITSIZE * 5,2,UNITSIZE * 9);
var cone;
var carriedCones = 0;
var pickUpItems = [];
var coneGeometry;
...
//    createChar();
    ...
    if(level == 4){
    	charMeshPosition = new THREE.Vector3(UNITSIZE * 5,WALLHEIGHT + 2,UNITSIZE * 9);
    }
...
function restartLevel() { 
	...
	if(bonusArray['lives'] < 1){
		...
		/*TODO: Make some kind of highscore list eventually, and make the player restart from level 1 / checkpoint?*/
		updateLives();
	}
	level = 0;
	resetChar();
...
//    audioArray['level1'].volume = 0;
    ...
    audioArray['life'] = new Audio('audio/320005__manuts__get-armour.wav');
    audioArray['life'].volume = 0.5;
    audioArray['life'].addEventListener('ended', function(){
    	this.currentTime = 0;
    });
}
...
function loadTextures(){
	...
	textureArray['stones1'] = textureLoader.load('images/stoneWall3.jpg');
	...
	textureArray['lifeBox'] = textureLoader.load('images/lifeBox.jpg');
	textureArray['dirt1'] = textureLoader.load('images/dirtFloor3.jpg');
	...
	textureArray['dirt2'] = textureLoader.load('images/dirtyFloor2.jpg');
	...
	textureArray['ice2'] = textureLoader.load('images/ice3.jpg');
}