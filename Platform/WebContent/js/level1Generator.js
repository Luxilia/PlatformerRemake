...
function generateLevel1(){
  ...
  [2, 1, 1, 1, 1, 1, 26, 1, 1, 1, 1, 2, 8, 2, 1, 2, 2], // 0
...
function generateLevel1Tips(){
	var tip0Vector = new THREE.Vector3(UNITSIZE*1, 2, UNITSIZE*6);
	var tip1Vector = new THREE.Vector3(UNITSIZE*5, 2, UNITSIZE*3);
	var tip2Vector = new THREE.Vector3(UNITSIZE*8, 2, UNITSIZE*6);
	var tip3Vector = level1StartPosition;
	var tip4Vector = new THREE.Vector3(UNITSIZE*5, 2, UNITSIZE*1);
	var tip0String = "There will be traps...";
	var tip1String = "Some traps have laser triggers that can be avoided.";
	var tip2String = "Other traps trigger through hidden trigger plates. These traps often need some time to reset. Hint: Some objects, like crates, can trigger traps.";
	var tip3String = "Find your way to the next level. Try to gather Dungs on the way, for points! :)";
	var tip4String = "Good job! You seem to have made it through level 1 :D";
	var tip0 = new Tips(tip0String, tip0Vector);
	levelTips.push(tip0);
	var tip1 = new Tips(tip1String, tip1Vector);
	levelTips.push(tip1);
	var tip2 = new Tips(tip2String, tip2Vector);
	levelTips.push(tip2);
	var tip3 = new Tips(tip3String, tip3Vector);
	levelTips.push(tip3);
	var tip4 = new Tips(tip4String, tip4Vector);
	levelTips.push(tip4);
}
