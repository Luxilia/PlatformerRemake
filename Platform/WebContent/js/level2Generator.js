...
function generateLevel2(){
	...
	scene.add(ambientLight);
	 floorTexture = textureArray['marble1']
	  roofTexture = textureArray['dirt2']
	  wallTexture = textureArray['stones1']
	maps = [];
	var level2Map = [
		               [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
			            [2, 8, 2, 1, 1, 1, 1, 2, 20, 1, 1, 1, 1, 1, 1, 1, 2],
			            [2, 15, 2, 2, 2, 2, 2, 20, 1, 1, 1, 1, 1, 2, 2, 1, 2],
			            [2, 1, 1, 1, 1, 1, 21, 1, 1, 1, 1, 1, 2, 12, 2, 13, 2],
			            [2, 1, 17, 1, 2, 2, 2, 2, 1, 1, 2, 2, 1, 1, 2, 13, 2],
			            [2, 1, 1, 1, 2, 1, 1, 1, 1, 1, 1, 1, 2, 1, 2, 13, 2],
			            [2, 2, 2, 2, 2, 1, 2, 1, 1, 1, 1, 1, 2, 1, 2, 13, 2],
			            [2, 9, 0, 9, 1, 1, 2, 1, 2, 2, 1, 1, 2, 1, 2, 1, 2],
			            [2, 0, 9, 0, 1, 1, 2, 1, 2, 1, 1, 2, 2, 1, 2, 1, 2],
			            [2, 0, 0, 0, 1, 1, 2, 1, 2, 1, 1, 2, 8, 1, 2, 27, 2],
			            [2, 0, 0, 0, 1, 2, 1, 1, 2, 1, 1, 2, 2, 1, 2, 2, 2],
			            [2, 0, 0, 0, 2, 1, 16, 1, 2, 1, 1, 2, 2, 1, 1, 1, 2],
			            [2, 0, 0, 0, 2, 1, 16, 1, 2, 1, 1, 19, 17, 2, 0, 1, 2],
			            [2, 9, 0, 9, 2, 1, 16, 1, 2, 2, 2, 2, 2, 0, 0, 0, 2],
			            [2, 0, 17, 0, 2, 1, 16, 1, 2, 1, 10, 0, 0, 25, 0, 1, 2],
			            [2, 10, 0, 0, 2, 1, 1, 1, 21, 1, 0, 0, 0, 10, 0, 0, 2],
			            [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
		               ];
	maps.push(level2Map);
	doorNumber = 1;
    ...
    objLoader.load('models/objects/trap_blade/trap_blade.obj', 'models/objects/trap_blade/trap_blade.mtl', trapBladeLoadedCallback2);
    objLoader.load('models/enemies/enemy_egyptian_mask/enemy_egyptian_mask.obj', 'models/enemies/enemy_egyptian_mask/enemy_egyptian_mask.mtl', enemyLoadedCallback2);
    objLoader.load('models/objects/trap_spikes_ground/bloody/trap_spikes_ground_bloody.obj', 'models/objects/trap_spikes_ground/bloody/trap_spikes_ground_bloody.mtl', groundSpikesBloodyLoadedCallback2);
...
function generateLevel2Tips(){
	var tip1Vector = new THREE.Vector3(UNITSIZE*10, 2, UNITSIZE*12);
	var tip2Vector = new THREE.Vector3(UNITSIZE*3, 2, UNITSIZE*3);
	var tip3Vector = new THREE.Vector3(UNITSIZE*15, 2, UNITSIZE*7);
	var tip1Text = "Sometimes you can click on things with the mouse. The red dot in the middle indicates when this is possible.";
	var tip2Text = "Enemies will follow you until they are dead, or too far away.";
	var tip3Text = "Extra lives can be well worth picking up. If you lose all your lives, you have to start from the beginning again.";
	var tip1 = new Tips(tip1Text, tip1Vector);
	var tip2 = new Tips(tip2Text, tip2Vector);
	var tip3 = new Tips(tip3Text, tip3Vector);
	levelTips.push(tip1);
	levelTips.push(tip2);
	levelTips.push(tip3);
...
//}
//
//function createZombieEnemy(x,y,z){
...
//		}
//	});
//	zombie.position.set(UNITSIZE*x, WALLHEIGHT*y + 2, UNITSIZE*z);
//	
//	scene.add(zombie);
